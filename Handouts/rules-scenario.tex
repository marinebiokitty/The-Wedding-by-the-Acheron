...
very well.  {\bf Someone with a CR of three has normal skill level at combat.}
...
\aAssist{}'s CR added (``\aKnockOut{} 3'', ``\aAssist{} 2'', ``\aKnockOut{}
5'').  \aAssist{} does not change your CR for defense.  You may ignore
an \aAssist{}.


Knock Out attacks do not require any item. Rope is {\bf not} freely available.
