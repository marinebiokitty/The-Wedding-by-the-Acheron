...
\NEW{MemFold}{\mFresiExplosives}{
  \s\MYname	{If you see Item #\iExplosives{\MYnumber}, open this.}
  \s\MYtext	{This is both terrific and terrifying-- it's one of the bags of explosives stolen from your ship!}
}
%Paldeen, Izdubar
\NEW{MemFold}{\mAllergy}{
  \s\MYname	{If you ingest Item #\iFruit{\MYnumber}, open this.}
...
\NEW{MemFold}{\mThief}{
  ...
  \s\MYtext	{You recognize this person from a portrait in a dusty storeroom of Etruria's castle . . . Oh! This diviner is the splitting image of the last \cThief{\monarch} of Etruria, dethroned by Hyperion Coronus!}
}
%Fresi
\NEW{MemFold}{\mHackEtruria}{
  \s\MYname	{Open this when you successfully hack communication machine #\iEtruriaCommunicator{\MYnumber.}
  \s\MYtext	{"0" = a multi-pronged, all-out attack. "1" = a series of moderately hostile activites. "2" = no military activity.}
}
%Fresi
\NEW{MemFold}{\mHackScythia}{
  \s\MYname	{Open this when you successfully hack communication machine #\iScythiaCommunicator{\MYnumber.}
  \s\MYtext	{"2" = a multi-pronged, all-out attack. "1" = a series of moderately hostile activites. "0" and "4" = no military activity.}
}