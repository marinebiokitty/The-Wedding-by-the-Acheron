...
\NEW{MemFold}{\mAlcoholism}{
  ...
  \s\MYtext	{Alas, you have relapsed into alcoholism. If you are offered a drink, you cannot refuse it. Additionally, you must consume at least two drinks every hour. Every time you finish a full hour without consuming two drinks, take two points of psychic damage.}
}
%Paldeen, Izdubar
...
\NEW{MemFold}{\mThief}{
  ...
  \s\MYtext	{You recognize this person from a portrait in a dusty storeroom of Etruria's castle . . . Oh! This diviner is the splitting image of the last queen of Etruria, dethroned by Hyperion Coronus!}
}
%Fresi
\NEW{MemFold}{\mHackEtruria}{
  \s\MYname	{Open this if you successfully hack communication machine 6666.}
  \s\MYtext	{"0" = a multi-pronged, all-out attack. "1" = a series of moderately hostile activities. "2" = no military activity.}
}
%Fresi
\NEW{MemFold}{\mHackScythia}{
  \s\MYname	{Open this if you successfully hack communication machine 7777.}
  \s\MYtext	{"2" = a multi-pronged, all-out attack. "1" = a series of moderately hostile activities. "0" and "4" = no military activity.}
}