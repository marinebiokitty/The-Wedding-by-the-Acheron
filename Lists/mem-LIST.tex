...
\NEW{MemFold}{\mFresiExplosives}{
  ...
  \s\MYtext	{Sugar? Flour? No, this is something far more terrifying - it?s one of the bags of high explosive stolen from your ship! Even this small bag is enough to send a score of soldiers to their graves. What could it be doing here?}
}
%Fresi
...
\NEW{MemEnvelope}{\mHackScythia}{
  ...
  \s\MYtext	{The wiring here is more complex than the devices you?re used to, but with a little finagling you?re able to reverse-engineer the communicator and figure out what message each button will send. Pressing the button marked ?2? will launch an all-out attack, pressing the button marked ?1? will heighten the nation?s border defenses, and pressing the buttons marked ?0? and ?4? will spark no additional military activity.}
}

%Meizon
\NEW{MemCover}{\mAmnesia}{
  \s\MYname	{}
  \s\MYmems	{\mAmnesiaOne{}\mAmnesiaTwo{}\mAmnesiaThree{}\mAmnesiaFour{}}
  }
