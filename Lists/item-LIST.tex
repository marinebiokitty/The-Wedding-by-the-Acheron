...
\NEW{Item}{\iWhatzit}{
 ...
 %6 copies in Maxenes' trunk
  ...
  \s\MYnumber	{0002}
  \s\MYtext	{A bottle of ale. If you consume this, destroy this card, and roll a d20. If your roll is under 3, you go unconscious for one minute. 1-hand bulky.}
  }
  %12 copies in Salo's trunk
        \NEW{Item}{\iCider}{
  \s\MYname	{Bottle of Hard Cider}
  \s\MYnumber	{0003}
  \s\MYtext	{A bottle of hard cider. If you consume this, destroy this card, and roll a d20. If your roll is under 3, you go unconscious for one minute. 1-hand bulky.}
  }
  %2 in Paldeen's trunk
        \NEW{Item}{\iGoldBottle}{
  \s\MYname	{Golden Bottle of Mead}
  \s\MYnumber	{0004}
  \s\MYtext	{A solid gold bottle of mead, spiced with cinnamon. If you consume this, destroy this card, and roll a d20. If your roll is under 3, you go unconscious for one minute. 1-hand bulky.}
  }
...
\NEW{Item}{\iSugar}{
 ...
 %Paldeen's trunk
  ...
  \s\MYnumber	{0014}
  \s\MYtext	{A shiny diadem. You can only wear one headdress at a time. If you put this on, see a GM. 1-hand bulky.}
  }
  %Diadem sign
          \NEW{Item}{\iDiadem}{
  \s\MYname	{Dusty Diadem}
  \s\MYnumber	{0015}
  \s\MYtext	{A somewhat dusty diadem. You can only wear one headdress at a time. If you put this on, see a GM. Unstashable. 1-hand bulky.}
  }
...
\NEW{Item}{\iLargeBell}{
  ...
  \s\MYname	{Signed Confession}
  \s\MYnumber	{0023}
  \s\MYtext	{A complete, magically verified confession from one of \cPoet{}'s former servants, proving \cPoet{} and \cBride{} had an affair.}
  }
 %Hiems' trunk 
  \NEW{ItemEnvelope}{\iEtruriaCommunicator}{
  \s\MYname	{Fancy Communication Machine}
  \s\MYnumber	{6666}
  \s\MYtext	{It has three buttons, labeled "0," "1," and "2." One button must be pressed at all times. To see which is pressed, check the paper inside this envelope;to press a different button, remove the paper, destroy it, and put in a new slip of paper with a different number from 0-2 written on it. This cannot be moved from \cEtruriaKing{}'s trunk.}
 ...
 %Meizon and Cryseon's trunk 
  ...
  \s\MYname	{Fancy Communication Machine}
  \s\MYnumber	{7777}
  \s\MYtext	{It has four buttons, labeled "0," "1," "2," and "3." One button must be pressed at all times. To see which is pressed, check the paper inside this envelope; to press a different button, remove the paper, destroy it, and put in a new slip of paper with a different number from 0-3 written on it. This cannot be moved from the Scythian monarchs' trunk.}
  \s\MYcontents	{\iButton{}}
  }
    %Communicators
\NEW{Item}{\iButton}{
