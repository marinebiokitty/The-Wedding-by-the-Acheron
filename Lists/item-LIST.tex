...
\NEW{Item}{\iSugar}{
 ...
 %Paldeen's trunk
  ...
  \s\MYnumber	{0014}
  \s\MYtext	{A shiny golden diadem. You can only wear one headdress at a time. If you put this on, see a GM. 1-hand bulky.}
  }
  %Diadem sign
          \NEW{Item}{\iDiadem}{
  \s\MYname	{Dusty Diadem}
  \s\MYnumber	{0015}
  \s\MYtext	{A somewhat dusty golden diadem. You can only wear one headdress at a time. If you put this on, see a GM. Unstashable. 1-hand bulky.}
  }
