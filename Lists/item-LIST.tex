...
\NEW{Item}{\iSugar}{
 ...
 %Paldeen's trunk
  ...
  \s\MYnumber	{0015}
  \s\MYtext	{A somewhat dusty diadem. You can only wear one headdress at a time. If you put this on, see a GM. 1-hand bulky.}
  }
...
\NEW{Item}{\iButton}{
 ...
 %Hiems' trunk 
  ...
  \s\MYnumber	{6666}
  \s\MYtext	{It has three buttons, labeled "0," "1," and "2." One button must be pressed at all times. To see which is pressed, check the paper inside this envelope; to press a different button, replace the paper with a different number from 0-2 written on it. This cannot be moved from \cEtruriaKing{}'s trunk.}
 ...
 %Meizon and Cryseon's trunk 
  ...
  \s\MYname	{Fancy Communication Machine}
  \s\MYnumber	{7777}
  \s\MYtext	{It has four buttons, labeled "0," "1," "2," and "3." One button must be pressed at all times. To see which is pressed, check the paper inside this envelope; to press a different button, replace the paper with a different number from 0-4 written on it. This cannot be moved from the Scythian monarchs' trunk.}
  \s\MYcontents	{\iButton{}}
  }
