...
\NEW{Abil}{\aFistOfWrath}{
  ...
  \s\MYtext	{To pick a lock, roll a d20 until you roll an odd number. Count how many rolls you make before this happens. You succeed if your total number of rolls is greater than or equal to the lock's Difficulty stat; otherwise, you can try again. If you a roll a 1, you make a clumsy, obvious mistake; write "Tampered With" on the lock's sign.}
