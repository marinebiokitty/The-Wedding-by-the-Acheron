...
\NEW{Abil}{\aFistOfWrath}{
  ...
  \s\MYtext	{If you are firmly convinced that someone is responsible for your mother's death, you can inflict a killing blow upon them, provided they are unconscious, willing or paralyzed. Your CR must be at least 1 to use this ability.}
  \s\MYeffect	{I attack you with deadly force, propelled by vengeful rage.}
  }
  %Delia, Eidola, Maxenes, Izdubar, Leda
\NEW{Abil}{\aLockpicking}{
  ...
  \s\MYeffect	{I am tampering with this lock.}
  }
  %Delia
