...
\NEW{Abil}{\aBluffmasterAdd}{
  ...
  \s\MYtext	{You can add 3 to any player's sum in Bluffmaster. Initially, you can use this ability once per set. Every time you play three full sets of Bluffmaster, you can use this ability an additional time per set, to a maximum of 3 time per set.}
  \s\MYeffect	{I add a bonus to a roll.}
  }
