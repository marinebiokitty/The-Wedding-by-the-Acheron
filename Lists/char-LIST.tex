...
\NEW{PC}{\cArchaeologist}{
   ...
   \s\MYsex {\female}
   \s\MYnumber	{0002}
   \s\MYdesc     {A young woman with exquisitely coiffed hair and a friendly smile.}
...
\NEW{PC}{\cBride}{
   ...
   \s\MYsex {\female}
   \s\MYnumber	{0005}
   \s\MYdesc     {A delicate young woman with soft blue eyes.}
...
\NEW{PC}{\cButler}{
   ...
   \s\MYsex {\male}
   \s\MYnumber	{0006}
   \s\MYdesc     {A tall young man with messy black hair.}
...
\NEW{PC}{\cGroom}{
   ...
   \s\MYsex {\male}
   \s\MYnumber	{0008}
   \s\MYdesc     {A short young man with golden curls.}
...
\NEW{PC}{\cEtruriaKing}{
  ...
  \s\MYblues	{\bGeneralHistory{}\bSabine{}\bWhosWho{}}
  \s\MYgreens	{\gWedding{}\gBluffmaster{}\gEtruriaMachine{}\gEtruriaDiadem{}}
...
\NEW{PC}{\cScythiaKing}{
   ...
   \s\MYdesc     {A weary-looking man with a graying goatee.}
	 \s\MYplayer	{Song Wang}
      \s\MYcr	{3}
  \s\MYblues	{\bGeneralHistory{}\bSabine{}\bWhosWho{}}
  \s\MYgreens	{\gWedding{}\gBluffmaster{}\gScythiaMachine{}\gScythiaDiadem{}}
...
\NEW{PC}{\cWard}{
   ...
   \s\MYsex {\female}
   \s\MYnumber	{0014}
   \s\MYdesc     {A tall, slender teenager with a bounce in her step.}
	 \s\MYplayer	{Alex Chu}
  \s\MYblues	{\bGeneralHistory{}\bSabine{}\bWhosWho{}\bSoulblades{}}
  \s\MYgreens	{\gWedding{}\gAppraise{}\gBluffmaster{}\gWardSoulMagic{}}
