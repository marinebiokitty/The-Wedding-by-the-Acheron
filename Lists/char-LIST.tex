...
\NEW{PC}{\cAnarchist}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aKillingBlow{}\aTamper{}\aNeedlePoison{}\aImprovedWaylay{}\aFirstAid{}\aChronicPoisoning{}\aAcutePoisoningResistance{}\aLockpicking{}\aBluffmasterSubtract{}} 
...
\NEW{PC}{\cArchaeologist}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aFirstAid{}\aBluffmasterAdd{}\aBluffmasterSubtract{}} 
    \s\MYcr	{3}
  \s\MYwhites	{}
  \s\MYmems {}
} 
...
\NEW{PC}{\cArmsDealer}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aHack{}\aBluffmasterAdd{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
...
\NEW{PC}{\cAssassin}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aFirstAid{}\aAcutePoisoningResistance{}\aKillingBlow{}\aTamper{}\aNeedlePoison{}\aImprovedWaylay{}\aLockpicking{}\aBluffmasterReroll{}\aBluffmasterSubtract{}} 
  \s\MYitems	{\iUnconsciousnessPoison{}\iUnconsciousnessPoison{}\iCRPoison{}\iCRPoison{}}
    \s\MYcr	{1}
...
\NEW{PC}{\cBride}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTruthingTwo{}\aTruthingResistanceTwo{}\aBluffmasterSubtract{}\aAlcoholismBeginning{}\aLockpicking{}} 
      \s\MYcr	{3}
...
\NEW{PC}{\cButler}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTamper{}\aFirstAid{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
  \s\MYmems {}
} 
...
\NEW{PC}{\cFugitive}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aFirstAid{}\aSoullessness{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
  \s\MYmems {}
} 
...
\NEW{PC}{\cGroom}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aFirstAid{}\aTruthingOne{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
      \s\MYcr	{3}
  \s\MYmems {}
} 
...
\NEW{PC}{\cEtruriaKing}{
  ...
  \s\MYgreens	{\gWedding{}}
<<<<<<< Updated upstream
  \s\MYabils	{\aTruthingTwo{}\aBluffmasterMedium{}\aTruthingTwo{}\aBluffmasterSubtract{}} 
  \s\MYitems	{\iBlackmail{}\iSecondBlackmail{}}
=======
  \s\MYabils	{\aTruthingTwo{}\aTruthingTwo{}} 
  \s\MYitems	{\iBlackmail{}\cSecondBlackmail}
>>>>>>> Stashed changes
      \s\MYcr	{3}
  \s\MYwhites	{}
  \s\MYmems {\mAchillea{}}
...
\NEW{PC}{\cMerchant}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTruthingResistanceOne{}\aBluffmasterAdd{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
  \s\MYmems {\mAllergy{}}
}
...
\NEW{PC}{\cWard}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTamper{}\aFirstAid{}\aTruthingOne{}\aLockpicking{}\aBluffmasterSubtract{}\aBluffmasterReroll{}} 
  \s\MYwhites	{}
      \s\MYcr	{3}
...
\NEW{PC}{\cBurglar}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aImprovedLockpicking{}\aFirstAid{}\aLockpicking{}\aBluffmasterSubtract{}\aBluffmasterReroll{}} 
  \s\MYwhites	{}
  \s\MYmems {}
}
