...
\NEW{PC}{\cButler}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTamper{}\aFirstAid{}\aBluffmasterSubtract{}\aWhisperer{}} 
  \s\MYwhites	{}
  \s\MYmems {}
...
\NEW{PC}{\cEtruriaKing}{
  ...
  \s\MYabils	{\aTruthingTwo{}\aTruthingTwo{}\aBluffmasterSubtract{}} 
...
\NEW{PC}{\cScythiaKing}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTruthingOne{}\aAlcoholism{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
...
\NEW{PC}{\cPoet}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aFistOfWrath{}\aPoetryBonus{}\aTruthingOne{}\aBluffmasterSubtract{}} 
  \s\MYwhites	{}
      \s\MYcr	{3}
  \s\MYmems {}
      \s\MYcash{\cash{Coins}{100}}
