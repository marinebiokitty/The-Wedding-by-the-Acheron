...
\NEW{PC}{\cAssassin}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aFirstAid{}\aAcutePoisoningResistance{}\aKillingBlow{}\aTamper{}\aNeedlePoison{}\aImprovedWaylay{}\aLockpicking{}} 
  \s\MYitems	{\iUnconsciousnessPoison{}\iUnconsciousnessPoison{}\iCRPoison{}\iCRPoison{}}
    \s\MYcr	{1}
...
\NEW{PC}{\cBride}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTruthingTwo{}\aTruthingResistanceTwo{}\aAlcoholismBeginning{}\aLockpicking{}} 
      \s\MYcr	{3}
...
\NEW{PC}{\cMerchant}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTruthingResistanceOne{}} 
  \s\MYwhites	{}
  \s\MYmems {\mAllergy{}}
}
...
\NEW{PC}{\cWard}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aTamper{}\aFirstAid{}\aTruthingOne{}\aLockpicking{}} 
  \s\MYwhites	{}
      \s\MYcr	{3}
...
\NEW{PC}{\cBurglar}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gWedding{}}
  \s\MYabils	{\aImprovedLockpicking{}\aFirstAid{}\aLockpicking{}} 
  \s\MYwhites	{}
  \s\MYmems {}
}
